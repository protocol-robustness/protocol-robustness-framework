...
(def domain-tags
  ...
  {:world-state     "WORLD_STATE_V1"
   ...
   :governed-authority-report-verification-basis-v1 "GOVERNED_AUTHORITY_REPORT_VERIFICATION_BASIS_V1"
   ...
   :governed-authority-legacy-input-capture-v1 "GOVERNED_AUTHORITY_LEGACY_INPUT_CAPTURE_V1"
   :three-member-authority-report-v1 "THREE_MEMBER_AUTHORITY_REPORT_V1"
