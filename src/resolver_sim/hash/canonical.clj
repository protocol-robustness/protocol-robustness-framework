...
(def domain-tags
  ...
  {:replay-frame "PRF_REPLAY_FRAME_V1"
   ...
   :pro-rata-allocation-application "PRO_RATA_ALLOCATION_APPLICATION_V1"
   ...
   :allocation-quantity-target-map-validation "ALLOCATION_QUANTITY_TARGET_MAP_VALIDATION_V1"
   :allocation-quantity-target-map-validation-v2 "ALLOCATION_QUANTITY_TARGET_MAP_VALIDATION_V2"
   :sew-aggregate-held-credit-semantics "SEW_AGGREGATE_HELD_CREDIT_SEMANTICS_V1"
   :sew-aggregate-held-credit-numeric-realization-semantics "SEW_AGGREGATE_HELD_CREDIT_NUMERIC_REALIZATION_SEMANTICS_V1"
   :aggregate-custody-numeric-projection "AGGREGATE_CUSTODY_NUMERIC_PROJECTION_V1"
   :aggregate-numeric-custody-realization "AGGREGATE_NUMERIC_CUSTODY_REALIZATION_V1"
   :native-realization-adapter-descriptor "NATIVE_REALIZATION_ADAPTER_DESCRIPTOR_V1"
   :adapter-execution-context "ADAPTER_EXECUTION_CONTEXT_V1"
   :exact-native-leaf-write-set "EXACT_NATIVE_LEAF_WRITE_SET_V1"
   :actual-native-leaf-write-set "ACTUAL_NATIVE_LEAF_WRITE_SET_V1"
   :core-authorized-proposed-realization "CORE_AUTHORIZED_PROPOSED_REALIZATION_V1"
   :canonical-effect-transition "CANONICAL_EFFECT_TRANSITION_V1"
   :protocol-effect-adapter-identity "PROTOCOL_EFFECT_ADAPTER_IDENTITY_V1"
   :protocol-effect-write-set "PROTOCOL_EFFECT_WRITE_SET_V1"
   :protocol-effect-realization "PROTOCOL_EFFECT_REALIZATION_V1"
   :protocol-transaction-realization "PROTOCOL_TRANSACTION_REALIZATION_V1"
   :transact-operation "TRANSACT_OPERATION_V1"
   :transact-operations "TRANSACT_OPERATIONS_V1"
   :transact "TRANSACT_V1"
   :transact-trace "TRANSACT_TRACE_V1"
   :trace-bounded-transition "TRACE_BOUNDED_TRANSITION_V1"
   :transition-binding "TRANSITION_BINDING_V1"
   :transition-binding-semantics "TRANSITION_BINDING_SEMANTICS_V1"
   :transact-operation-footprint "TRANSACT_OPERATION_FOOTPRINT_V1"
   ...
   :review-governance-v1 "REVIEW_GOVERNANCE_V1"
   :review-position-acceptance-v1 "REVIEW_POSITION_ACCEPTANCE_V1"
   :position-time-basis-v1 "POSITION_TIME_BASIS_V1"
   :review-governance-admissibility-v1 "REVIEW_GOVERNANCE_ADMISSIBILITY_V1"
   :governed-authority-resolution-basis-v1 "GOVERNED_AUTHORITY_RESOLUTION_BASIS_V1"
   ...
   :authoritative-material-state-v1 "AUTHORITATIVE_MATERIAL_STATE_V1"
   :governed-authority-content-transition-v1 "GOVERNED_AUTHORITY_CONTENT_TRANSITION_V1"
   :governed-authority-derived-result-receipt-v1 "GOVERNED_AUTHORITY_DERIVED_RESULT_RECEIPT_V1"
   :governed-authority-signing-request-signature-v1 "GOVERNED_AUTHORITY_SIGNING_REQUEST_SIGNATURE_V1"
   :custody-signing-receipt-v1 "CUSTODY_SIGNING_RECEIPT_V1"
   :researcher-decision-k3 "RESEARCHER_DECISION_K3"
   ...
   :replication-observation-set "REPLICATION_OBSERVATION_SET_V1"
   ...
   :benchmark-manifest "BENCHMARK_MANIFEST_V1"
   :research-definition "RESEARCH_DEFINITION_V1"
   :research-axis "RESEARCH_AXIS_V1"
   ...
   :prf-resubmission-issue-request-v2 "PRF_RESUBMISSION_ISSUE_REQUEST_V2"
   ...
   :authority-state-dependency-manifest-v1 "AUTHORITY_STATE_DEPENDENCY_MANIFEST_V1"
