(ns resolver-sim.assurance.force-authorisation-portability-test
  "Benchmark portability assertion: force-authorisation claim evaluation
   ...
   Coverage note (Phase 3B): the frozen force-auth-add-held evidence artifact
   verification previously tested here moved into the held-custody extension
   (prf.extensions.held-custody.legacy-validate / legacy-add-held-test), the
   extension-owned permanent historical-read contract. This file retains the
   base-assurance coverage (resolver-sim.assurance.force-authorisation and
   resolver-sim.assurance.custody) that survives the legacy core removal."
