(ns resolver-sim.demos.public.provenance-test
  ...
  (:require [clojure.test :refer [deftest is testing]]
            ...
            [resolver-sim.demos.public.blocked-decision :as blocked]
...
(deftest blocked-decision-splices-are-rejected
  (let [artifact (blocked/project)]
...
(deftest pristine-artifacts-pass
  (testing "the real projected artifacts are self-consistent"
    (is (not (rejects? (blocked/project))))
